...
_DOMAINS: list[tuple[str, list[str]]] = [
    ...
    ("travel", [
        r"\btravel\b", r"\bdistance\b", r"\bkm\b", r"\bsurcharge\b", r"\boutside\b", r"\boutside our\b",
    ]),
    ("policy", [
    ...
    # service capability / operational questions
    ("other", [
        # key “supplies” intent (covers "do i gotta supply anything")
...
def classify_fact_domain(text: str) -> str:
    ...
    # Hard guarantees for “supplies / bring stuff / vacuum / products” questions
    if (
        "supplies" in t
        or "supply" in t
        or "equipment" in t
        ...
        return "other" if ("invoice" not in t and "invoices" not in t) else "payment"
